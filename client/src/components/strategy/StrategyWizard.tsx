...
export function StrategyWizard() {
  ...
  const handleChannelsSubmit = () => {
    ...
    if (conversationMode) {
      setMessages(prev => [
        ...prev,
        { text: `I've prioritized ${channels.filter(c => c.priority === 'high').map(c => c.name).join(', ')} as my primary channels.`, sender: 'user' },
        { text: "Based on your inputs, I'll now generate strategic recommendations for each stage of the customer lifecycle.", sender: 'assistant' }
      ]);
    }
  };
  ...
  const handleGoToSummary = () => {
    ...
    if (conversationMode) {
      setMessages(prev => [
        ...prev,
        { text: "I like these recommendations. Let's proceed to the summary.", sender: 'user' },
        { text: "Great! Here's a comprehensive summary of your marketing strategy across all customer lifecycle stages.", sender: 'assistant' }
      ]);
    }
  };
    ...
    switch (currentStep) {
      ...
      case 'channels':
        return (
          <div className="space-y-4">
            <div>
              <Label>Marketing Channels & Priorities</Label>
              ...
              <CardContent className="p-4">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="ml-6 mt-2">
                      <p><span className="font-medium">Primary Segment:</span> {audience.primarySegment}</p>
